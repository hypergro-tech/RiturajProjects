...
- Status pills: "QA passed · compliance review (BFSI)" (blue tint) · "Review required — extended pixels" / "Rebuilt — review required" (amber) · "Export blocked — compliance" / "Export blocked — failed QA gates" (red, no download).
- Blocked cards show the compliance message in a red tinted box instead of a preview: "This size cannot carry the mandatory disclaimer legibly. Requires manual layout or size exclusion."
